...
function Signup() {
  ...
  return (
    <div className="flex items-center w-full  min-h-screen justify-center  ">
            <div className={`mx-6 sm:mx-auto w-full max-w-lg  bg-white hover:shadow-2xl shadow-lg  duration-300 rounded-xl p-10 border border-black/10`}>
            <div className="mb-2 flex justify-center">
                ...
                <p className="mt-2 text-center text-base text-[#ff3358]">
